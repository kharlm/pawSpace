...
import { getPosts, likePost, unlikePost, getAdopt,getBreedPosts,flagPost } from '../../actions/post'
...
class BreedPosts extends React.Component {
    ...
    const mapDispatchToProps = (dispatch) => {
        return bindActionCreators({ getPosts, likePost, unlikePost, getUser, getAdopt,getDog,getBreedPosts,flagPost}, dispatch)
      }
