...
import { getPosts, likePost, unlikePost, getAdopt,getGenderPosts,flagPost } from '../../actions/post'
...
class GenderPosts extends React.Component {

  
    async componentDidMount() {
        const gender = this.props.navigation.getParam('gender','');
        console.log("gender: "+gender)
        this.props.getGenderPosts(gender)
        this.props.getPosts()
      ...
      likePost = (post) => {
        ...
        if (post.likes.includes(dogId)) {
          ...
          this.props.getGenderPosts(post.dog.gender)
        } else {
    ...
    const mapDispatchToProps = (dispatch) => {
        return bindActionCreators({ getPosts, likePost, unlikePost, getUser, getAdopt,getDog,getGenderPosts,flagPost}, dispatch)
      }
      ...
      export default connect(mapStateToProps, mapDispatchToProps)(GenderPosts)
